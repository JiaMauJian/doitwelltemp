...
public partial class Desktop : System.Web.UI.Page
{
    ...
    private void GetWorkList()
    {
        ...
        {            
            ...
            litWorkList.Text += string.Format("<li style='{3}'><a style='margin-left:5px' href='javascript:editWork({1}, {2}, {5}, {6})'>[編輯]</a><a style='margin-left:5px' href='javascript:deleteWork()'>[刪除]</a><span style='margin-left:5px;color:white;'>ID: {4} {0}: 寬:{1} 長:{2} (cm)</span></li>", jWork.product_type, jWork.width, jWork.height, "margin:0 5px 0 5px", jWork.order_detail_id, jWork.bleed_width, jWork.bleed_height);
        }        
    }
}