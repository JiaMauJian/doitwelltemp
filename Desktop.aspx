...
<body onload="clearLinkDot();">
    ...
    <div id="MainScope">
                    ...
                    <td align="right" style="background-color: #003366" width="250">
                        ...
                        <ul>
                           ...
                           <li><a href='#'><span>作品清單</span></a>
								...
								<ul style="background-color:green;margin-top:30px;width:300px;left:-140px;text-align:left;border-radius:0px;border:1px solid white;">									
        ...
        <div id="editArea" style="margin:5px">            
...
//工作清單功能
 {
     function editWork(w, h) {
            ...
            if (w > h)
                SCALE_FACTOR = 880 / (w * p); //桌布最大寬度
            else
                SCALE_FACTOR = 580 / (h * p); //桌布最大長度
